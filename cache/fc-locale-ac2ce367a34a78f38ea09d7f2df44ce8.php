...
<br />
{$editorialContactSignature}',
  'emails.submissionAck.description' => 'Email ini, jika diaktifkan, secara otomatis dikirimkan ke penulis saat menyelesaikan proses penyerahan naskah ke jurnal. Email ini memberikan informasi mengenai pemantauan kemajuan proses editorial dan mengucapkan terimakasih atas naskah yang dikirimkan.',
...
{$submissionAbstract}',
  ...
  'emails.reviewRequestRemindAuto.subject' => 'Permohonan Review Artikel',
...
<ul>
	...
	<li>Naskah ditolah bulan ini: {$declinedSubmissions}</li>
	<li>Naskah yng diterima bulan ini: {$acceptedSubmissions}</li>
	<li>Total naskah dalam sistem: {$totalSubmissions}</li>
</ul>
Login untuk melihat selengkapnya <a href="{$editorialStatsLink}">kecenderunga. editorial</a> dan <a href="{$publicationStatsLink}">statistik artikel yang dipublikasikan</a>. Salinan lengkap trend bulan ini terlampir.<br />
<br />
Salam Hormat,<br />
{$principalContactSignature}',
  'emails.statisticsReportNotification.description' => 'Email ini dikirim secara otomatis per bulan kepada editor dan manajer jurn untuk menyediakan pratinjau kestabilan sistem.',
